...
- [ ] Export workflows (PDF, Markdown download)
- [ ] Email notifications via Resend
- [ ] Retry + exponential backoff for all agent failures
- [ ] Vector pruning cron job (stale embeddings cleanup)
- [ ] Cost controls and deduplication guards
- [ ] End-to-end Playwright tests for critical paths
